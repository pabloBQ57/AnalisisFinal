    ...
    public class CrudAdmin : Conexion
    {
        ...
        public DataTable MostrarDonaciones()
        {
            using (var connection = GetConnection())
            {
                ...
                {
                    Command.Connection = connection;
                    Command.CommandText = "Sp_verdonaciones";
                    Command.CommandType = CommandType.StoredProcedure;
                    SqlDataReader reader = Command.ExecuteReader();
                    tabla.Load(reader);
        ...
        public void IngresoDonacion(string nombre, int cantidad)
        {
            using (var connection = GetConnection())
            {
                connection.Open();
                ...
                {
                    Command.Connection = connection;
                    Command.CommandText = "Sp_InsertarDonacion";
                    Command.CommandType = CommandType.StoredProcedure;
                    Command.Parameters.AddWithValue("@nombre", nombre);
                    Command.Parameters.AddWithValue("@cantidad", cantidad);
                    Command.ExecuteNonQuery();
        ...
        public void IngresoGasto(string nombre, int cantidad)
        {
            using (var connection = GetConnection())
            {
                connection.Open();
                ...
                {
                    Command.Connection = connection;
                    Command.CommandText = "Sp_IngresoGasto";
                    Command.CommandType = CommandType.StoredProcedure;
                    Command.Parameters.AddWithValue("@nombre", nombre);
                    Command.Parameters.AddWithValue("@cantidad", cantidad);
                    Command.ExecuteNonQuery();
        ...
        public DataTable MostrarGastos()
        {
            using (var connection = GetConnection())
            {
                ...
                {
                    Command.Connection = connection;
                    Command.CommandText = "Sp_MostrarGasto";
                    Command.CommandType = CommandType.StoredProcedure;
                    SqlDataReader reader = Command.ExecuteReader();
                    tabla.Load(reader);
