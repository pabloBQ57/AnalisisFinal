    ...
    public class CrudMedico:Conexion
    {
        ...
        public DataTable MostrarFicha()
        {
            using (var connection = GetConnection())
            {
                ...
                {
                    Command.Connection = connection;
                    Command.CommandText = "Sp_VerFicha";
                    Command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable MostrarFichaLab()
        {
            using (var connection = GetConnection())
            {
                connection.Open();
                ...
                {
                    Command.Connection = connection;
                    Command.CommandText = "Sp_fichalab";
                    Command.CommandType = CommandType.StoredProcedure;
                    SqlDataReader reader = Command.ExecuteReader();
                    tabla.Load(reader);
        ...
        public void Editar(int id,string resultados)
        {
            using (var connection = GetConnection())
            {
                connection.Open();
                ...
                {
                    Command.Connection = connection;
                    Command.CommandText = "Sp_EditarLab";
                    Command.CommandType = CommandType.StoredProcedure;
                    Command.Parameters.AddWithValue("idficha", id);
                    Command.Parameters.AddWithValue("resultados", resultados);
                    Command.ExecuteNonQuery();
                    Command.Parameters.Clear();
